			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo base_url('c_gudang/barang_gd') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('c_gudang/barang_gd/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('qty_bar') ? 'is-invalid':'' ?>"
								 type="number" name="qty_bar" min="0" placeholder="Qty" />
								<div class="invalid-feedback">
