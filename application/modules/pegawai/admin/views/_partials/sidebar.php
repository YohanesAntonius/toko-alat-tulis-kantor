...
<!--     <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'barang' ? 'active': '' ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('barang_msuk') ?>">
            <i class="far fa-arrow-alt-circle-down"></i>
            <span>Barang Masuk</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('barang_kluar') ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('admin/lst_usr') ?>">
