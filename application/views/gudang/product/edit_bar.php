			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('c_gudang/barang') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" c_gudang//barang/edit") ?>" method="post"
...
<div class="row">
							<div class="form-group col-sm-4">
								<label for="qty_bar">QTY</label>
								<input style="width: 70%;" class="form-control <?php echo form_error('qty_bar') ? 'is-invalid':'' ?>"
								 type="number" name="qty_bar" min="0" placeholder="Jumlah Barang" value="<?php echo $tbl_brng->qty_bar ?>" />
								<div class="invalid-feedback">
