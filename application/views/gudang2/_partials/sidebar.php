...
<ul class="sidebar navbar-nav">
    <li class="nav-item <?php echo $this->uri->segment(2) == '' ? 'active': '' ?>">
        <a class="nav-link" href="<?php echo site_url('gudang2') ?>">
...
<!--     <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'barang' ? 'active': '' ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('gudang2/brng_msuk_gd') ?>">
            <i class="far fa-arrow-alt-circle-down"></i>
            <span>Barang Masuk</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('gudang2/brng_kluar_gd') ?>">
            <i class="fas fa-sign-in-alt"></i>
            <span>Barang Keluar</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('gudang2/lsbarang') ?>">
            <i class="fas fa-box"></i>
            <span>List Barang</span></a>
    </li>

<!--     <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('gudang2/lst_usr') ?>">
