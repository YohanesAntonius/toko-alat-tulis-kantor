			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('gudang2/brng_msuk_gd') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('gudang2/tbh_barang_msuk') ?>" method="post" enctype="multipart/form-data" >
