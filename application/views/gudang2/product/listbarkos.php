			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('gudang2/tbhbarang') ?>"><i class="fas fa-plus"></i> Tambah</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="200">
											<a href="<?php echo site_url('gudang2/edtbarang/'.$tbl_brng->id_bar) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('gudang2/delbarang/'.$tbl_brng->id_bar) ?>')"
...
<!-- 											 <a href="<?php echo site_url('barang/brng_kluar/'.$tbl_brng->id_bar) ?>" style="color: green;" class="btn btn-small"><i class="fas fa-sign-out-alt"></i> Keluar</a> -->
	...
	<?php $this->load->view("gudang2/_partials/modal.php") ?>
