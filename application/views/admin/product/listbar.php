			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('barang/add') ?>"><i class="fas fa-plus"></i> Tambah</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a target="_blank" href="<?php echo site_url('barang/print') ?>"><i class="fas fa-print"></i> Cetak</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo site_url('barang/barkos') ?>"><i class="fas fa-box-open"></i> Barang Kosong</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo site_url('barang/barkos') ?>"><i class="fas fa-plus"></i> Tambah Merk</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo site_url('barang/barkos') ?>"><i class="fas fa-plus"></i> Tambah Jenis</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo site_url('barang/barkos') ?>"><i class="fas fa-plus"></i> Tambah Satuan</a>
					</div>
					<div class="card-body">
