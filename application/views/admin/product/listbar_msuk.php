			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('barang_msuk/add') ?>"><i class="fas fa-plus"></i> Tambah</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a target="_blank" href="<?php echo site_url('barang_msuk/print') ?>"><i class="fas fa-print"></i> Cetak</a>
					</div>
					<div class="card-body">
